...
class CaptureController {
 public:
  ...
  // Reads latest preview frame from memory in BGRA order.
  virtual bool GetLatestFrameBgra(std::vector<uint8_t>* out,
                                  uint32_t* width,
                                  uint32_t* height) = 0;
};
...
class CaptureControllerImpl : public CaptureController,
 ...
 public:
  ...
  bool GetLatestFrameBgra(std::vector<uint8_t>* out, uint32_t* width,
